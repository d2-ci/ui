...
export var LogoIconWhite = function LogoIconWhite() {
  return React.createElement(LogoIcon, {
    fill: "#fff"
  });
};
export function Logo(_ref2) {
...
export var LogoWhite = function LogoWhite() {
