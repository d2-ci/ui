  ...
  _createClass(SplitButton, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", {
        ...
        className: "jsx-".concat(_theme.fonts.__hash, " jsx-").concat(_styles.default.__hash, " jsx-").concat(_styles2.default.__hash)
      }, _react.default.createElement("button", {
        disabled: this.props.disabled,
        onClick: this.props.onClick,
        className: "jsx-".concat(_theme.fonts.__hash, " jsx-").concat(_styles.default.__hash, " jsx-").concat(_styles2.default.__hash) + " " + ((0, _classnames.default)('base', "kind-".concat(this.props.kind), "size-".concat(this.props.size), this.props.className, {
          'icon-only': this.props.icon && !this.props.label && !this.props.children,
          icon: this.props.icon
        }) || "")
      }, this.props.icon && _react.default.createElement("span", {
        className: "jsx-".concat(_theme.fonts.__hash, " jsx-").concat(_styles.default.__hash, " jsx-").concat(_styles2.default.__hash) + " " + "button-icon"
      }, this.props.icon), this.props.label || this.props.children), _react.default.createElement("button", {
        disabled: this.props.disabled,
        onClick: this.onToggle,
        className: "jsx-".concat(_theme.fonts.__hash, " jsx-").concat(_styles.default.__hash, " jsx-").concat(_styles2.default.__hash) + " " + ((0, _classnames.default)('base', "kind-".concat(this.props.kind), "size-".concat(this.props.size)) || "")
      }, icon), open && _react.default.createElement("div", {
        ref: function ref(c) {
          return _this2.elMenu = c;
        },
        className: "jsx-".concat(_theme.fonts.__hash, " jsx-").concat(_styles.default.__hash, " jsx-").concat(_styles2.default.__hash) + " " + "menu"
