...
(0, _vitest.describe)('toDHIS2PeriodData', () => {
  (0, _vitest.describe)('month periods', () => {
    (0, _vitest.it)('should generate correct month periods for a single month', () => {
      const result = (0, _timePeriodUtils.toDHIS2PeriodData)('2024-01', '2024-01', 'month');
    ...
    (0, _vitest.it)('should generate correct month periods for multiple months', () => {
      const result = (0, _timePeriodUtils.toDHIS2PeriodData)('2024-01', '2024-03', 'month');
    ...
    (0, _vitest.it)('should generate correct month periods spanning years', () => {
      const result = (0, _timePeriodUtils.toDHIS2PeriodData)('2023-11', '2024-02', 'month');
  ...
  (0, _vitest.describe)('week periods', () => {
    (0, _vitest.it)('should generate correct week periods for a single week', () => {
      const result = (0, _timePeriodUtils.toDHIS2PeriodData)('2024-W01', '2024-W01', 'week');
      (0, _vitest.expect)(result).toHaveLength(1);
      (0, _vitest.expect)(result[0].id).toBe('2024W1');
    });
    (0, _vitest.it)('should generate correct week periods for multiple weeks', () => {
      const result = (0, _timePeriodUtils.toDHIS2PeriodData)('2024-W01', '2024-W03', 'week');
      (0, _vitest.expect)(result).toHaveLength(3);
      (0, _vitest.expect)(result[0].id).toBe('2024W1');
...
(0, _vitest.describe)('convertServerToClientPeriod', () => {
  (0, _vitest.describe)('month periods', () => {
    (0, _vitest.it)('should convert server month format to client format', () => {
      ...
      (0, _vitest.expect)((0, _timePeriodUtils.convertServerToClientPeriod)('202312', 'MONTH')).toBe('2023-12');
    });
    (0, _vitest.it)('should handle lowercase period type', () => {
      (0, _vitest.expect)((0, _timePeriodUtils.convertServerToClientPeriod)('202401', 'month')).toBe('2024-01');
    });
    (0, _vitest.it)('should return original value for invalid month format', () => {
      (0, _vitest.expect)((0, _timePeriodUtils.convertServerToClientPeriod)('invalid', 'MONTH')).toBe('invalid');
    });
  });
  (0, _vitest.describe)('week periods', () => {
    (0, _vitest.it)('should convert server week format to client format', () => {
      ...
      (0, _vitest.expect)((0, _timePeriodUtils.convertServerToClientPeriod)('2024W52', 'WEEK')).toBe('2024-W52');
    });
    (0, _vitest.it)('should handle lowercase period type', () => {
      (0, _vitest.expect)((0, _timePeriodUtils.convertServerToClientPeriod)('2024W01', 'week')).toBe('2024-W01');
    });
    (0, _vitest.it)('should return original value for invalid week format', () => {
      (0, _vitest.expect)((0, _timePeriodUtils.convertServerToClientPeriod)('invalid', 'WEEK')).toBe('invalid');
    });
  });
  (0, _vitest.describe)('unsupported period types', () => {
    (0, _vitest.it)('should return original value for unsupported period type', () => {
      (0, _vitest.expect)((0, _timePeriodUtils.convertServerToClientPeriod)('2024', 'YEAR')).toBe('2024');
      (0, _vitest.expect)((0, _timePeriodUtils.convertServerToClientPeriod)('20240101', 'DAY')).toBe('20240101');
    });
  });
});
(0, _vitest.describe)('comparePeriods', () => {
  (0, _vitest.describe)('month periods', () => {
    (0, _vitest.it)('should return negative when first period is earlier', () => {
      (0, _vitest.expect)((0, _timePeriodUtils.comparePeriods)('202401', '202402', 'MONTH')).toBeLessThan(0);
    });
    (0, _vitest.it)('should return positive when first period is later', () => {
      (0, _vitest.expect)((0, _timePeriodUtils.comparePeriods)('202402', '202401', 'MONTH')).toBeGreaterThan(0);
    });
    (0, _vitest.it)('should return zero when periods are equal', () => {
      (0, _vitest.expect)((0, _timePeriodUtils.comparePeriods)('202401', '202401', 'MONTH')).toBe(0);
    });
    (0, _vitest.it)('should correctly compare periods across years', () => {
      (0, _vitest.expect)((0, _timePeriodUtils.comparePeriods)('202312', '202401', 'MONTH')).toBeLessThan(0);
    });
  });
  (0, _vitest.describe)('week periods', () => {
    (0, _vitest.it)('should return negative when first period is earlier', () => {
      (0, _vitest.expect)((0, _timePeriodUtils.comparePeriods)('2024W01', '2024W02', 'WEEK')).toBeLessThan(0);
    });
    (0, _vitest.it)('should return positive when first period is later', () => {
      (0, _vitest.expect)((0, _timePeriodUtils.comparePeriods)('2024W02', '2024W01', 'WEEK')).toBeGreaterThan(0);
    });
    (0, _vitest.it)('should return zero when periods are equal', () => {
      (0, _vitest.expect)((0, _timePeriodUtils.comparePeriods)('2024W01', '2024W01', 'WEEK')).toBe(0);
    });
    (0, _vitest.it)('should correctly compare periods across years', () => {
      (0, _vitest.expect)((0, _timePeriodUtils.comparePeriods)('2023W52', '2024W01', 'WEEK')).toBeLessThan(0);
    });
  });
  (0, _vitest.describe)('unsupported period types', () => {
    (0, _vitest.it)('should fall back to string comparison for unsupported types', () => {
      const result = (0, _timePeriodUtils.comparePeriods)('2024', '2025', 'YEAR');
...
(0, _vitest.describe)('sortPeriods', () => {
  (0, _vitest.describe)('month periods', () => {
    (0, _vitest.it)('should sort month periods chronologically', () => {
      ...
      const sorted = (0, _timePeriodUtils.sortPeriods)(periods, 'MONTH');
  ...
  (0, _vitest.describe)('week periods', () => {
    (0, _vitest.it)('should sort week periods chronologically', () => {
      ...
      const sorted = (0, _timePeriodUtils.sortPeriods)(periods, 'WEEK');
...
(0, _vitest.describe)('getLastNPeriods', () => {
  (0, _vitest.describe)('month periods', () => {
    (0, _vitest.it)('should return the last N months including the base period', () => {
      const result = (0, _timePeriodUtils.getLastNPeriods)('202412', 'MONTH', 3);
      (0, _vitest.expect)(result).toEqual(['202410', '202411', '202412']);
    });
    (0, _vitest.it)('should return 12 months for a full year', () => {
      const result = (0, _timePeriodUtils.getLastNPeriods)('202412', 'MONTH', 12);
    ...
    (0, _vitest.it)('should handle periods spanning years', () => {
      const result = (0, _timePeriodUtils.getLastNPeriods)('202402', 'MONTH', 4);
      (0, _vitest.expect)(result).toEqual(['202311', '202312', '202401', '202402']);
    });
    (0, _vitest.it)('should return single period when count is 1', () => {
      const result = (0, _timePeriodUtils.getLastNPeriods)('202412', 'MONTH', 1);
      (0, _vitest.expect)(result).toEqual(['202412']);
    });
    (0, _vitest.it)('should return empty array for invalid base period', () => {
      const result = (0, _timePeriodUtils.getLastNPeriods)('invalid', 'MONTH', 3);
      (0, _vitest.expect)(result).toEqual([]);
    });
    (0, _vitest.it)('should return empty array for count <= 0', () => {
      (0, _vitest.expect)((0, _timePeriodUtils.getLastNPeriods)('202412', 'MONTH', 0)).toEqual([]);
      (0, _vitest.expect)((0, _timePeriodUtils.getLastNPeriods)('202412', 'MONTH', -1)).toEqual([]);
    });
  });
  (0, _vitest.describe)('week periods', () => {
    (0, _vitest.it)('should return the last N weeks including the base period', () => {
      const result = (0, _timePeriodUtils.getLastNPeriods)('2024W10', 'WEEK', 3);
      (0, _vitest.expect)(result).toEqual(['2024W08', '2024W09', '2024W10']);
    });
    (0, _vitest.it)('should handle periods spanning years', () => {
      const result = (0, _timePeriodUtils.getLastNPeriods)('2024W02', 'WEEK', 4);
      (0, _vitest.expect)(result).toHaveLength(4);
      (0, _vitest.expect)(result[3]).toBe('2024W02');
    });
    (0, _vitest.it)('should return single period when count is 1', () => {
      const result = (0, _timePeriodUtils.getLastNPeriods)('2024W10', 'WEEK', 1);
      (0, _vitest.expect)(result).toEqual(['2024W10']);
    });
    (0, _vitest.it)('should return empty array for invalid base period', () => {
      const result = (0, _timePeriodUtils.getLastNPeriods)('invalid', 'WEEK', 3);
      (0, _vitest.expect)(result).toEqual([]);
    });
  });
  (0, _vitest.describe)('unsupported period types', () => {
    (0, _vitest.it)('should return empty array for unsupported period type', () => {
      const result = (0, _timePeriodUtils.getLastNPeriods)('2024', 'YEAR', 3);
      (0, _vitest.expect)(result).toEqual([]);
    });
  });
});